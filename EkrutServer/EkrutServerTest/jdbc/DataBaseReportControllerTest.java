...
class DataBaseReportControllerTest {
	...
	void setUp() throws Exception {
		...
		data = new Hashtable<>();
	     ...
	     DataBaseController.connectToDataBase(new DataBaseConnectionDetails("jdbc:mysql://{IP}/ekrut?serverTimezone=IST","localhost","root","Aa123456"),new ServerScreenController());
